const  XBOT = 'Cubjrnet7 BOT'; // Nama Bot Whatsapp
const instagram = 'https://instagram.com/Setyo.wibowo27'; // Nama Instagramlu cok
const nomer = 'https://Wa.me/+6281231971005'; // Nomor whatsapplu cok
const aktif = 'Tergantung kuota'; // Kapan bot lu aktif
const groupwa = 'https://chat.whatsapp.com/FCj8UCm1BhIEWCd0xVUaLt'; // OFFICIAL GRUP
const youtube = 'https://youtube.com/channel/UCL2QBjToBCMkKTf66wC2KaQ'; 
...
const vcard = 'BEGIN:VCARD\n' // metadata of the contact card
            + 'VERSION:3.0\n' 
            + 'FN:affis\n' // full name
            + 'ORG:Owner  Cubjrnet7 Bot;\n' // the organization of the contact
            + 'TEL;type=CELL;type=VOICE;waid=6281231971005:+62 812-3197-1005\n' // WhatsApp ID + phone number
            + 'END:VCARD'
